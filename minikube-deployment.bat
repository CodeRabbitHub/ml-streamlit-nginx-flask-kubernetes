...
REM Wait for 5 seconds to ensure Minikube starts
timeout /t 5 /nobreak
...
REM Wait for 5 seconds to allow status check completion
timeout /t 5 /nobreak
...
REM Wait for 5 seconds to allow the tunnel to start
timeout /t 5 /nobreak
...
REM Wait for 5 seconds to ensure deployments start
timeout /t 5 /nobreak
